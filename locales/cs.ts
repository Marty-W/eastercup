...
export default {
  ...
  "form.meansOfTransport": "Doprava (volitelne)",
  ...
  "form.interestInAccomodation": "Mate zajem o ubytovani?",
  "form.interestInCatering": "Mate zajem o stravovani?",
  "form.interestInTshirts": "Mate zajem o turnajove dresy?",
  "form.noXsShirts": "Pocet XS dresu",
  "form.noSShirts": "Pocet S dresu",
  "form.noMShirts": "Pocet M dresu",
  "form.noLShirts": "Pocet L dresu",
  "form.noXLShirts": "Pocet XL dresu",
  "form.noXXLShirts": "Pocet XXL dresu",
  "form.tshirts.error": "Toto pole je povinne",
  "form.accomodation.error": "Toto pole je povinne",
  "form.catering.error": "Toto pole je povinne",
  "form.required": "Toto pole je povinne",
  "form.companyName": "Nazev spolecnosti",
  "form.address": "Adresa",
  "form.city": "Mesto",
  "form.zipCode": "PSC",
  "form.ic": "IC",
  "form.dic": "DIC (volitelne)",
} as const;
